...
export default function AnimePage(): JSX.Element {
  ...
  function logDebug(line: string) {
    setDebugLog((s) => [line, ...s].slice(0, 100));
  }
    ...
    <main className="min-h-screen bg-gradient-to-b from-[#071227] via-[#0f172a] to-[#071324] text-white p-6">
      <section className="max-w-5xl mx-auto">
        <header className="mb-6 text-center">
          ...
          <p className="mt-2 text-slate-300 max-w-2xl mx-auto">Search Anichin, watch episodes inline (HLS support), or grab direct download hosts. Cards animate into view as you scroll.</p>
        </header>
          ...
          <div className="space-y-6">
            ...
            {results.map((s, i) => (
              <article
                ...
                className="opacity-0 transform translate-y-6 transition-all duration-600 ease-out will-change-transform bg-gradient-to-b from-white/3 to-white/2 border border-white/6 rounded-2xl overflow-hidden shadow-lg"
                // in-view class will be added by IntersectionObserver
                // style defined below in <style jsx>
              >
                {/* square image container */}
                <div style={{ position: "relative", width: "100%", paddingBottom: "100%", background: "linear-gradient(90deg,#0b1220,#0f172a)" }}>
                  <img
            ...
            <div className="relative z-10 w-full max-w-4xl bg-[#071227] rounded-xl shadow-lg p-4">
              ...
              <div className="bg-black rounded-md overflow-hidden">
                <video
                  ...
                  // for mp4: set src; for m3u8, HLS will attach
              ...
              <div className="mt-3 text-xs text-slate-400">
                Playback tries HLS (m3u8) first with hls.js (dynamically loaded). If that fails the best host will be shown in Download options. If the player cannot play the file, click Download to open hosts.
              </div>
            </div>
          </div>
        )}
      ...
      <style jsx>{`
        ...
        /* entrance animation: initial state -> in-view */
        article {
