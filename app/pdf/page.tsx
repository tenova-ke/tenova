...
export default function TextToPdfPage() {
  const [input, setInput] = useState("This is a demo text converted into PDF 🚀");
  ...
  async function generatePdf() {
    if (!input.trim()) {
      setError("⚠️ Please enter some text, a URL, or an image path.");
      return;
    }
    ...
    try {
      ...
      // ✅ API returns a PDF file (not JSON)
