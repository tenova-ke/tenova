  ...
  return (
    <div className="p-6 max-w-3xl mx-auto bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white min-h-screen">
      <h1 className="text-4xl font-bold mb-2 text-green-400 drop-shadow-lg flex items-center gap-2">
        <Binary className="w-8 h-8" /> Binary Converter
      </h1>
      <p className="text-gray-300 mb-6">
        Encode text into binary or decode binary back to text instantly.
      </p>
      ...
      <button
        ...
        disabled={loading}
        className="mt-4 px-6 py-3 bg-green-600 rounded-full font-semibold shadow-md hover:bg-green-500 transition disabled:opacity-50 flex items-center gap-2"
      >
        {loading ? (
          <>
        ...
        <div className="mt-8 bg-gray-800 p-4 rounded-2xl shadow-lg">
          ...
          <div className="flex flex-col gap-3">
            <textarea
              ...
              readOnly
              rows={4}
              className="w-full p-3 rounded-2xl bg-gray-900 text-green-200 font-mono"
            />
            <button
              onClick={handleCopy}
      ...
      <div className="mt-12 text-gray-300 leading-relaxed">
        ...
        <ol className="list-decimal pl-6 space-y-2">
          ...
          <li>Enter your text or binary string.</li>
          <li>Click <strong className="text-green-400">Convert</strong> to get the result.</li>
